...
// include: C:\Users\domro\AppData\Local\Temp\tmpefep9o7a.js
...
// end include: C:\Users\domro\AppData\Local\Temp\tmpefep9o7a.js
// include: C:\Users\domro\AppData\Local\Temp\tmpahr32xgi.js

    // All the pre-js content up to here must remain later on, we need to run
    // it.
    if ((typeof ENVIRONMENT_IS_WASM_WORKER != 'undefined' && ENVIRONMENT_IS_WASM_WORKER) || (typeof ENVIRONMENT_IS_PTHREAD != 'undefined' && ENVIRONMENT_IS_PTHREAD) || (typeof ENVIRONMENT_IS_AUDIO_WORKLET != 'undefined' && ENVIRONMENT_IS_AUDIO_WORKLET)) Module['preRun'] = [];
    var necessaryPreJSTasks = Module['preRun'].slice();
  // end include: C:\Users\domro\AppData\Local\Temp\tmpahr32xgi.js
// include: C:\Users\domro\AppData\Local\Temp\tmptr4wnt1o.js

    if (!Module['preRun']) throw 'Module.preRun should exist because file support used it; did a pre-js delete it?';
    necessaryPreJSTasks.forEach((task) => {
      if (Module['preRun'].indexOf(task) < 0) throw 'All preRun tasks that exist before user pre-js code should remain after; did you replace Module or modify Module.preRun?';
    });
  // end include: C:\Users\domro\AppData\Local\Temp\tmptr4wnt1o.js
...
var ASM_CONSTS = {
  137944: () => { if (document.fullscreenElement) return 1; },  
 137990: () => { return document.getElementById('canvas').width; },  
 138042: () => { return parseInt(document.getElementById('canvas').style.width); },  
 138110: () => { document.exitFullscreen(); },  
 138137: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 138210: () => { if (document.fullscreenElement) return 1; },  
 138256: () => { return document.getElementById('canvas').width; },  
 138308: () => { return screen.width; },  
 138333: () => { document.exitFullscreen(); },  
 138360: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 138493: () => { return window.innerWidth; },  
 138519: () => { return window.innerHeight; },  
 138546: () => { if (document.fullscreenElement) return 1; },  
 138592: () => { return document.getElementById('canvas').width; },  
 138644: () => { return parseInt(document.getElementById('canvas').style.width); },  
 138712: () => { if (document.fullscreenElement) return 1; },  
 138758: () => { return document.getElementById('canvas').width; },  
 138810: () => { return screen.width; },  
 138835: () => { return window.innerWidth; },  
 138861: () => { return window.innerHeight; },  
 138888: () => { if (document.fullscreenElement) return 1; },  
 138934: () => { return document.getElementById('canvas').width; },  
 138986: () => { return screen.width; },  
 139011: () => { document.exitFullscreen(); },  
 139038: () => { if (document.fullscreenElement) return 1; },  
 139084: () => { return document.getElementById('canvas').width; },  
 139136: () => { return parseInt(document.getElementById('canvas').style.width); },  
 139204: () => { document.exitFullscreen(); },  
 139231: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 139289: () => { return screen.width; },  
 139314: () => { return screen.height; },  
 139340: () => { return window.screenX; },  
 139367: () => { return window.screenY; },  
 139394: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 139447: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 139518: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 139575: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 139831: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 139902: () => { if (document.fullscreenElement) return 1; },  
 139948: () => { return window.innerWidth; },  
 139974: () => { return window.innerHeight; },  
 140001: () => { if (document.pointerLockElement) return 1; }
};
