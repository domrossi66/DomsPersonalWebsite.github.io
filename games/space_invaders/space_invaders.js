...
// include: C:\Users\domro\AppData\Local\Temp\tmpv8c3uit6.js
...
Module['FS_createPath']("/", "Sounds", true, true);
    ...
    loadPackage({"files": [{"filename": "/Font/monogram.ttf", "start": 0, "end": 10468}, {"filename": "/Graphics/alien_1.png", "start": 10468, "end": 12295}, {"filename": "/Graphics/alien_2.png", "start": 12295, "end": 14129}, {"filename": "/Graphics/alien_3.png", "start": 14129, "end": 16055}, {"filename": "/Graphics/alien_ship.png", "start": 16055, "end": 17891}, {"filename": "/Graphics/spaceship.png", "start": 17891, "end": 19530}, {"filename": "/Sounds/explosion.ogg", "start": 19530, "end": 30505}, {"filename": "/Sounds/lazer.ogg", "start": 30505, "end": 46679}, {"filename": "/Sounds/music.ogg", "start": 46679, "end": 1235566}], "remote_package_size": 1235566});

  })();

// end include: C:\Users\domro\AppData\Local\Temp\tmpv8c3uit6.js
// include: C:\Users\domro\AppData\Local\Temp\tmp5idg2i1z.js

    // All the pre-js content up to here must remain later on, we need to run
    // it.
    if ((typeof ENVIRONMENT_IS_WASM_WORKER != 'undefined' && ENVIRONMENT_IS_WASM_WORKER) || (typeof ENVIRONMENT_IS_PTHREAD != 'undefined' && ENVIRONMENT_IS_PTHREAD) || (typeof ENVIRONMENT_IS_AUDIO_WORKLET != 'undefined' && ENVIRONMENT_IS_AUDIO_WORKLET)) Module['preRun'] = [];
    var necessaryPreJSTasks = Module['preRun'].slice();
  // end include: C:\Users\domro\AppData\Local\Temp\tmp5idg2i1z.js
// include: C:\Users\domro\AppData\Local\Temp\tmpk9oi8oxc.js

    if (!Module['preRun']) throw 'Module.preRun should exist because file support used it; did a pre-js delete it?';
    necessaryPreJSTasks.forEach((task) => {
      if (Module['preRun'].indexOf(task) < 0) throw 'All preRun tasks that exist before user pre-js code should remain after; did you replace Module or modify Module.preRun?';
    });
  // end include: C:\Users\domro\AppData\Local\Temp\tmpk9oi8oxc.js
...
var ASM_CONSTS = {
  149848: () => { if (document.fullscreenElement) return 1; },  
 149894: () => { return document.getElementById('canvas').width; },  
 149946: () => { return parseInt(document.getElementById('canvas').style.width); },  
 150014: () => { document.exitFullscreen(); },  
 150041: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 150114: () => { if (document.fullscreenElement) return 1; },  
 150160: () => { return document.getElementById('canvas').width; },  
 150212: () => { return screen.width; },  
 150237: () => { document.exitFullscreen(); },  
 150264: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 150397: () => { return window.innerWidth; },  
 150423: () => { return window.innerHeight; },  
 150450: () => { if (document.fullscreenElement) return 1; },  
 150496: () => { return document.getElementById('canvas').width; },  
 150548: () => { return parseInt(document.getElementById('canvas').style.width); },  
 150616: () => { if (document.fullscreenElement) return 1; },  
 150662: () => { return document.getElementById('canvas').width; },  
 150714: () => { return screen.width; },  
 150739: () => { return window.innerWidth; },  
 150765: () => { return window.innerHeight; },  
 150792: () => { if (document.fullscreenElement) return 1; },  
 150838: () => { return document.getElementById('canvas').width; },  
 150890: () => { return screen.width; },  
 150915: () => { document.exitFullscreen(); },  
 150942: () => { if (document.fullscreenElement) return 1; },  
 150988: () => { return document.getElementById('canvas').width; },  
 151040: () => { return parseInt(document.getElementById('canvas').style.width); },  
 151108: () => { document.exitFullscreen(); },  
 151135: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 151193: () => { return screen.width; },  
 151218: () => { return screen.height; },  
 151244: () => { return window.screenX; },  
 151271: () => { return window.screenY; },  
 151298: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 151351: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 151422: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 151479: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 151735: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 151806: () => { if (document.fullscreenElement) return 1; },  
 151852: () => { return window.innerWidth; },  
 151878: () => { return window.innerHeight; },  
 151905: () => { if (document.pointerLockElement) return 1; },  
 151952: ($0, $1, $2, $3, $4) => { if (typeof window === 'undefined' || (window.AudioContext || window.webkitAudioContext) === undefined) { return 0; } if (typeof(window.miniaudio) === 'undefined') { window.miniaudio = { referenceCount: 0 }; window.miniaudio.device_type = {}; window.miniaudio.device_type.playback = $0; window.miniaudio.device_type.capture = $1; window.miniaudio.device_type.duplex = $2; window.miniaudio.device_state = {}; window.miniaudio.device_state.stopped = $3; window.miniaudio.device_state.started = $4; miniaudio.devices = []; miniaudio.track_device = function(device) { for (var iDevice = 0; iDevice < miniaudio.devices.length; ++iDevice) { if (miniaudio.devices[iDevice] == null) { miniaudio.devices[iDevice] = device; return iDevice; } } miniaudio.devices.push(device); return miniaudio.devices.length - 1; }; miniaudio.untrack_device_by_index = function(deviceIndex) { miniaudio.devices[deviceIndex] = null; while (miniaudio.devices.length > 0) { if (miniaudio.devices[miniaudio.devices.length-1] == null) { miniaudio.devices.pop(); } else { break; } } }; miniaudio.untrack_device = function(device) { for (var iDevice = 0; iDevice < miniaudio.devices.length; ++iDevice) { if (miniaudio.devices[iDevice] == device) { return miniaudio.untrack_device_by_index(iDevice); } } }; miniaudio.get_device_by_index = function(deviceIndex) { return miniaudio.devices[deviceIndex]; }; miniaudio.unlock_event_types = (function(){ return ['touchend', 'click']; })(); miniaudio.unlock = function() { for(var i = 0; i < miniaudio.devices.length; ++i) { var device = miniaudio.devices[i]; if (device != null && device.webaudio != null && device.state === window.miniaudio.device_state.started) { device.webaudio.resume().then(() => { Module._ma_device__on_notification_unlocked(device.pDevice); }, (error) => {console.error("Failed to resume audiocontext", error); }); } } miniaudio.unlock_event_types.map(function(event_type) { document.removeEventListener(event_type, miniaudio.unlock, true); }); }; miniaudio.unlock_event_types.map(function(event_type) { document.addEventListener(event_type, miniaudio.unlock, true); }); } window.miniaudio.referenceCount += 1; return 1; },  
 154110: () => { if (typeof(window.miniaudio) !== 'undefined') { window.miniaudio.referenceCount -= 1; if (window.miniaudio.referenceCount === 0) { delete window.miniaudio; } } },  
 154274: () => { return (navigator.mediaDevices !== undefined && navigator.mediaDevices.getUserMedia !== undefined); },  
 154378: () => { try { var temp = new (window.AudioContext || window.webkitAudioContext)(); var sampleRate = temp.sampleRate; temp.close(); return sampleRate; } catch(e) { return 0; } },  
 154549: ($0, $1, $2, $3, $4, $5) => { var deviceType = $0; var channels = $1; var sampleRate = $2; var bufferSize = $3; var pIntermediaryBuffer = $4; var pDevice = $5; if (typeof(window.miniaudio) === 'undefined') { return -1; } var device = {}; var audioContextOptions = {}; if (deviceType == window.miniaudio.device_type.playback && sampleRate != 0) { audioContextOptions.sampleRate = sampleRate; } device.webaudio = new (window.AudioContext || window.webkitAudioContext)(audioContextOptions); device.webaudio.suspend(); device.state = window.miniaudio.device_state.stopped; var channelCountIn = 0; var channelCountOut = channels; if (deviceType != window.miniaudio.device_type.playback) { channelCountIn = channels; } device.scriptNode = device.webaudio.createScriptProcessor(bufferSize, channelCountIn, channelCountOut); device.scriptNode.onaudioprocess = function(e) { if (device.intermediaryBufferView == null || device.intermediaryBufferView.length == 0) { device.intermediaryBufferView = new Float32Array(Module.HEAPF32.buffer, pIntermediaryBuffer, bufferSize * channels); } if (deviceType == miniaudio.device_type.capture || deviceType == miniaudio.device_type.duplex) { for (var iChannel = 0; iChannel < channels; iChannel += 1) { var inputBuffer = e.inputBuffer.getChannelData(iChannel); var intermediaryBuffer = device.intermediaryBufferView; for (var iFrame = 0; iFrame < bufferSize; iFrame += 1) { intermediaryBuffer[iFrame*channels + iChannel] = inputBuffer[iFrame]; } } _ma_device_process_pcm_frames_capture__webaudio(pDevice, bufferSize, pIntermediaryBuffer); } if (deviceType == miniaudio.device_type.playback || deviceType == miniaudio.device_type.duplex) { _ma_device_process_pcm_frames_playback__webaudio(pDevice, bufferSize, pIntermediaryBuffer); for (var iChannel = 0; iChannel < e.outputBuffer.numberOfChannels; ++iChannel) { var outputBuffer = e.outputBuffer.getChannelData(iChannel); var intermediaryBuffer = device.intermediaryBufferView; for (var iFrame = 0; iFrame < bufferSize; iFrame += 1) { outputBuffer[iFrame] = intermediaryBuffer[iFrame*channels + iChannel]; } } } else { for (var iChannel = 0; iChannel < e.outputBuffer.numberOfChannels; ++iChannel) { e.outputBuffer.getChannelData(iChannel).fill(0.0); } } }; if (deviceType == miniaudio.device_type.capture || deviceType == miniaudio.device_type.duplex) { navigator.mediaDevices.getUserMedia({audio:true, video:false}) .then(function(stream) { device.streamNode = device.webaudio.createMediaStreamSource(stream); device.streamNode.connect(device.scriptNode); device.scriptNode.connect(device.webaudio.destination); }) .catch(function(error) { console.log("Failed to get user media: " + error); }); } if (deviceType == miniaudio.device_type.playback) { device.scriptNode.connect(device.webaudio.destination); } device.pDevice = pDevice; return miniaudio.track_device(device); },  
 157377: ($0) => { return miniaudio.get_device_by_index($0).webaudio.sampleRate; },  
 157443: ($0) => { var device = miniaudio.get_device_by_index($0); if (device.scriptNode !== undefined) { device.scriptNode.onaudioprocess = function(e) {}; device.scriptNode.disconnect(); device.scriptNode = undefined; } if (device.streamNode !== undefined) { device.streamNode.disconnect(); device.streamNode = undefined; } device.webaudio.close(); device.webaudio = undefined; device.pDevice = undefined; },  
 157836: ($0) => { miniaudio.untrack_device_by_index($0); },  
 157879: ($0) => { var device = miniaudio.get_device_by_index($0); device.webaudio.resume(); device.state = miniaudio.device_state.started; },  
 158004: ($0) => { var device = miniaudio.get_device_by_index($0); device.webaudio.suspend(); device.state = miniaudio.device_state.stopped; }
};
